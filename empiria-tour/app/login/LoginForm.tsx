...
/** Google's "G", in its four brand colours — the mark Google's own sign-in buttons carry. Decorative: the words say what the button does. */
function GoogleMark() {
  return (
...
const oauthClass =
  'w-full items-center justify-center rounded-lg border border-line bg-paper px-3 py-2.5 text-sm font-medium text-ink transition-colors hover:border-flame hover:bg-sand/40 disabled:opacity-60 inline-flex gap-2.5';
